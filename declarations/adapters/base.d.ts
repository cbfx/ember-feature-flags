 ...
 */
export default abstract class BaseFeatureFlagAdapter<TConfig = Record<string, unknown>> {
    /**
     ...
     */
    abstract identify(_user: FlagUser, _traits?: Record<string, unknown>): Promise<void>;
    /**
     ...
     */
    abstract variation<T = unknown>(_flagName: string, _options?: VariationOptions<T>): T;
    /**
